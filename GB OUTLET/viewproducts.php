  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <li ><a style="color: #fff;" href="index.php" >HOME</a></li>
          ...
          echo $count
      ?>)</a></li>
          <li ><a style="color: #fff;" href="proceed_to_checkout.php">CHECKOUT</a></li>
          <li ><a style="color: #fff;"href="view_orders.php">ORDERS</a></li>
		  <li><a style="color: #fff;" href="searchpage.php" class="fa fa-search" aria-hidden="true">SEARCH</a></li>
...
<br><center><h1 >Latest Products</h1 ></center>
